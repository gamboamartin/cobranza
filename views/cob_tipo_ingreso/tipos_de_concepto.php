<?php /** @var gamboamartin\cobranza\controllers\controlador_cob_tipo_ingreso $controlador  controlador en ejecucion */ ?>
            ...
            <div class="col-lg-12">
                <div class="widget  widget-box box-container form-main widget-form-cart" id="form">
                    <form method="post" action="<?php echo $controlador->link_cob_tipo_concepto_alta_bd; ?>" class="form-additional">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success" value="tipos_de_concepto" name="btn_action_next">Alta</button><br>
                        </div>
                    </form>
                </div>
            </div>
