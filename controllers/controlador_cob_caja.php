...
class controlador_cob_caja extends _ctl_base {

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){

        $modelo = new cob_caja(link: $link);
        $html_ = new cob_caja_html(html: $html);
        $obj_link = new links_menu(link: $link, registro_id:$this->registro_id);


        $datatables = new stdClass();
        $datatables->columns = array();
        $datatables->columns['cob_caja_id']['titulo'] = 'Id';
        $datatables->columns['cob_caja_codigo']['titulo'] = 'Cod';
        $datatables->columns['cob_caja_descripcion']['titulo'] = 'Caja';
        ...
        $datatables->filtro[] = 'cob_caja.id';
        $datatables->filtro[] = 'cob_caja.codigo';
        $datatables->filtro[] = 'cob_caja.descripcion';
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $keys_selects = $this->key_select(cols:12, con_registros: true,filtro:  array(), key: 'bn_cuenta_id',
            keys_selects: array(), id_selected: -1, label: 'Cuenta');
        if(errores::$error){
    ...
    protected function key_selects_txt(array $keys_selects): array
    {
        ...
        $keys_selects = (new \base\controller\init())->key_select_txt(cols: 12,key: 'descripcion', keys_selects:$keys_selects, place_holder: 'Caja');
        if(errores::$error){
            return $this->errores->error(mensaje: 'Error al maquetar key_selects',data:  $keys_selects);
        }
        ...
        bool $header, bool $ws = false): array|stdClass
    {
        ...
        $keys_selects = $this->key_select(cols:12, con_registros: true,filtro:  array(), key: 'bn_cuenta_id',
            keys_selects: array(), id_selected: $this->registro['bn_cuenta_id'], label: 'Cuenta');
        if(errores::$error){
            return $this->retorno_error(mensaje: 'Error al maquetar key_selects',data:  $keys_selects, header: $header,ws:  $ws);
        }
