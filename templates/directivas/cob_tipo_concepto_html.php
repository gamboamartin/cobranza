...
class cob_tipo_concepto_html extends html_controler {

    private function asigna_inputs(controlador_cob_tipo_concepto $controler, stdClass $inputs): array|stdClass
    {
    ...
    private function genera_inputs_modifica(controlador_cob_tipo_concepto $controler,PDO $link,
    ...
    public function select_cob_tipo_concepto_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
