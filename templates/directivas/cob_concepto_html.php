...
class cob_concepto_html extends html_controler {
    ...
    private function asigna_inputs(controlador_cob_concepto $controler, stdClass $inputs): array|stdClass
    {
        $controler->inputs->select = new stdClass();
        return $controler->inputs;
    }

    public function genera_inputs_alta(controlador_cob_concepto $controler, PDO $link): array|stdClass
    {
    ...
    private function genera_inputs_modifica(controlador_cob_concepto $controler,PDO $link,
    ...
    public function inputs_cob_concepto(controlador_cob_concepto $controlador,
                                    stdClass $params = new stdClass()): array|stdClass
    {
    ...
    public function select_cob_concepto_id(int $cols, bool $con_registros, int $id_selected, PDO $link, bool $disabled): array|string
    {
        ...
        $select = $this->select_catalogo(cols:$cols,con_registros:$con_registros,id_selected:$id_selected,
            modelo: $modelo, disabled: $disabled, label: 'Concepto',required: true);
        if(errores::$error){
